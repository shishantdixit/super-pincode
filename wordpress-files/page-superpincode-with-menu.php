<?php
/**
 * Template Name: SuperPincode with Menu
 * Description: SuperPincode page with WordPress menu bar
 */
...
<style>
/* SuperPincode Custom Styles with Menu Integration */

/* Override theme container to make full width */
.ast-container,
.site-content,
.entry-content {
        ...
        const officeCard = `
            <div class="col-md-6">
                <div class="card h-100 border-primary">
                    <div class="card-body">
                        <h6 class="card-title text-primary"><i class="bi bi-building"></i> ${record.officename}</h6>
                        <p class="card-text small mb-1"><i class="bi bi-pin-map text-muted"></i> <strong>Pincode:</strong> ${record.pincode || '-'}</p>
                        <p class="card-text small mb-1"><i class="bi bi-geo-alt text-muted"></i> <strong>District:</strong> ${record.district || '-'}</p>
                        <p class="card-text small mb-1"><i class="bi bi-map text-muted"></i> <strong>State:</strong> ${record.statename || '-'}</p>
                        <p class="card-text small mb-1"><i class="bi bi-tags text-muted"></i> <strong>Circle:</strong> ${record.circlename || '-'}</p>
                        <p class="card-text small mb-1"><i class="bi bi-building-fill text-muted"></i> <strong>Office Type:</strong> ${record.officetype || '-'}</p>
                        <p class="card-text small mb-0"><i class="bi bi-mailbox text-muted"></i> <strong>Delivery:</strong> ${record.delivery || '-'}</p>
                    </div>
                </div>
            </div>
        `;
    ...
    postOffices.forEach((office) => {
        const officeCard = `
            <div class="col-md-6">
                <div class="card h-100 border-primary">
                    <div class="card-body">
                        <h6 class="card-title text-primary"><i class="bi bi-building"></i> ${office.Name}</h6>
                        <p class="card-text small mb-1"><i class="bi bi-pin-map text-muted"></i> <strong>Pincode:</strong> ${office.Pincode || '-'}</p>
                        <p class="card-text small mb-1"><i class="bi bi-geo-alt text-muted"></i> <strong>District:</strong> ${office.District || '-'}</p>
                        <p class="card-text small mb-1"><i class="bi bi-map text-muted"></i> <strong>State:</strong> ${office.State || '-'}</p>
                        <p class="card-text small mb-1"><i class="bi bi-building-fill text-muted"></i> <strong>Branch Type:</strong> ${office.BranchType || '-'}</p>
                        <p class="card-text small mb-0"><i class="bi bi-mailbox text-muted"></i> <strong>Delivery Status:</strong> ${office.DeliveryStatus || '-'}</p>
                    </div>
                </div>
            </div>
        `;
        ...
        const officeCard = `
            <div class="col-md-6">
                <div class="card h-100 border-primary">
                    <div class="card-body">
                        <h6 class="card-title text-primary"><i class="bi bi-building"></i> ${office.Name}</h6>
                        <p class="card-text small mb-1"><i class="bi bi-geo-alt text-muted"></i> <strong>Branch Type:</strong> ${office.BranchType || '-'}</p>
                        <p class="card-text small mb-1"><i class="bi bi-mailbox text-muted"></i> <strong>Delivery Status:</strong> ${office.DeliveryStatus || '-'}</p>
                        <p class="card-text small mb-0"><i class="bi bi-pin-map text-muted"></i> <strong>Pincode:</strong> ${office.Pincode || '-'}</p>
                    </div>
                </div>
            </div>
        `;
